...
event emited by the plugin (see below). In
...
triggered. See EMITED EVENTS section for details. B<Defaults to:>
...
can specify in the C<response_event> of the construcor (it defaults to
C<irc_you_are_doing_it_wrong_response>) will recieve input from the
...
(see description of the C<trigger> argument to the contructor) or C<undef>
...
If an error occured during while fetching the link to a random image
...
If no errors occured (see C<error> above), the C<pic> key will contain
...
Please report any bugs or feature requests to C<bug-poe-component-irc-plugin-youaredoingitwrong at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-IRC-Plugin-YouAreDoingItWrong>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-IRC-Plugin-YouAreDoingItWrong>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-IRC-Plugin-YouAreDoingItWrong>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-IRC-Plugin-YouAreDoingItWrong>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-IRC-Plugin-YouAreDoingItWrong>
